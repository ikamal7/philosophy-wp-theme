                            ...
                            <div class="entry__info">
                                <a href="<?php echo esc_url($post_data[0]['author_url']); ?>"
                                   class="entry__profile-pic">
                                    <img class="avatar"
                                         src="<?php echo esc_url($post_data[0]['author_avatar']); ?>" alt="<?php echo esc_attr($post_data[0]['author']); ?>">
                                </a>

                                <ul class="entry__meta">
                                    <li>
                                        <a href="<?php echo esc_url($post_data[0]['author_url']); ?>"><?php echo esc_html($post_data[0]['author']); ?></a>
                                    </li>
                        ...
                        <div class="entry"
                            ...
                            <div class="entry__content">
                                ...
                                <h1><a href="<?php echo esc_url($post_data[$i]['permalink']); ?>"
                                       title="<?php echo esc_html($post_data[0]['title']); ?>"><?php echo esc_html($post_data[$i]['title']); ?></a></h1>

                                <div class="entry__info">
                                    <a href="<?php echo esc_url($post_data[$i]['author_url']); ?>"
                                       class="entry__profile-pic">
                                    ...
                                    <ul class="entry__meta">
                                        <li>
                                            <a href="<?php echo esc_url($post_data[$i]['author_url']); ?>"><?php echo esc_html($post_data[$i]['author']); ?></a>
                                        </li>
